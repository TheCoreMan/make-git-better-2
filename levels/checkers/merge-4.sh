...
pushd $dump_dir
    ...
    if [[ $(./runme.py) != *"The current git version you're playing with is"* ]] ; then
...
# level info
## title merge-4 
## branch multichord-ethicalism-fenestration -> That means the tag is multichord-ethicalism-fenestration-tag
